...
```{r}
#install.packages("addinslist")     ####devtools::install_github("rstudio/addinexamples", type = "source")
...
# colourpicker
  colourpicker:::colourPickerAddin() # also colourpicker:::plotHelperAddin()
...
* try `datapasta` to include a minimal reprex 
* include images
